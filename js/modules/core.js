...
class NotificationManager {
    ...
    async processQueue() {
        ...
        notificationEl.innerHTML = `
            ...
            <button class="notification-close" data-notification-id="${notificationId}"><i class="fas fa-times"></i></button>
        ...
        setTimeout(() => this.closeNotification(notificationId), 4000);
...
class SecurityManager {
    constructor() { this.bannedCountries = []; }
    async initializeSecurity(tgId) { return true; }
}

export { CacheManager, NotificationManager, SecurityManager };
